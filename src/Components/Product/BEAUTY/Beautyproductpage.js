...
export default function Beautyproductpage() {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:3004/data`)
      .then(res => res.json())
      .then(data => {
        const beautyproduct = findProductInCategory(data, 'BEAUTY', id);

        const productToSet = beautyproduct || findProductInCategory(data, 'BEAUTY', id);
  ...
  const findProductInCategory = (data, category, productId) => {
    ...
    if (categoryContainingProduct) {
      return categoryContainingProduct.Beautydata.find(product => product.id === parseInt(productId));
    }
    return null;
  };
          ...
          <div className="col-md-5">
            ...
            <div className="ratings my-2">
              <div className="stars d-flex">
                ...
                <div className="ml-2">(4) 50 Reviews</div>
              </div>
            </div>
